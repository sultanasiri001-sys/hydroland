...
expectThrow(()=>assertOperationalClearance({...ready,safetyDecision:null}),'OPERATIONS_SAFETY_BLOCK');
expectThrow(()=>assertOperationalClearance({...ready,safetyDecision:'REVIEW_REQUIRED'}),'OPERATIONS_SAFETY_BLOCK');
expectThrow(()=>assertOperationalClearance({...ready,complianceDecision:'REVIEW_REQUIRED'}),'OPERATIONS_COMPLIANCE_BLOCK');
expectThrow(()=>assertOperationalClearance({...ready,complianceDecision:null}),'OPERATIONS_COMPLIANCE_BLOCK');
expectThrow(()=>assertOperationalClearance({...ready,complianceDecision:'DEFERRED'}),'OPERATIONS_COMPLIANCE_BLOCK');
