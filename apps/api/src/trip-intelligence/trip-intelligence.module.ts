...
@Module({imports:[AuditModule,AuthModule,DatabaseModule],controllers:[TripIntelligenceController],providers:[TripIntelligenceService],exports:[TripIntelligenceService]})
