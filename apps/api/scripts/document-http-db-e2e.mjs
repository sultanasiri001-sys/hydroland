...
try{
 ...
 if(snapshots.length!==2||snapshots[0].version!==1||snapshots[0].payload?.summary!=='اختبار عربي HYD-2026 1,234.50'||snapshots[1].version!==2||snapshots[1].payload?.summary!=='revision 2')throw new Error('Immutable revision snapshots invalid');
