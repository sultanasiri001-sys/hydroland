...
try{
 ...
 if(stored.status!=='ARCHIVED'||stored.lifecycleEvents.length!==5)throw new Error('Lifecycle persistence invalid: status='+stored.status+' events='+stored.lifecycleEvents.length);
