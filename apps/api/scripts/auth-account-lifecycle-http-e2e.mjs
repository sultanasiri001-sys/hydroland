...
try{
  ...
  result=await request('/auth/email-verification/request',{body:{email},headers:{'x-forwarded-for':'203.0.113.34'}});
  assert(result.response.status===202&&result.payload.accepted===true,'verified account verification request must remain enumeration-safe');
