...
const { InventoryFoundationService } = require('../.tmp-inventory-validation/inventory-foundation.service.js');
const { InventoryWorkflowService } = require('../.tmp-inventory-validation/inventory-workflow.service.js');
const { InventoryOperationsService } = require('../.tmp-inventory-validation/inventory-operations.service.js');
const { InventoryGovernanceService } = require('../.tmp-inventory-validation/inventory-governance.service.js');
