...
CREATE TABLE "DivePlan" ("id" TEXT NOT NULL,"tripId" TEXT NOT NULL,"version" INTEGER NOT NULL,"plan" JSONB NOT NULL,"approvedAt" TIMESTAMP(3),"createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,"updatedAt" TIMESTAMP(3) NOT NULL,CONSTRAINT "DivePlan_pkey" PRIMARY KEY ("id"));
CREATE TABLE "EmergencyPlan" ("id" TEXT NOT NULL,"tripId" TEXT NOT NULL,"version" INTEGER NOT NULL,"plan" JSONB NOT NULL,"approvedAt" TIMESTAMP(3),"createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,"updatedAt" TIMESTAMP(3) NOT NULL,CONSTRAINT "EmergencyPlan_pkey" PRIMARY KEY ("id"));
