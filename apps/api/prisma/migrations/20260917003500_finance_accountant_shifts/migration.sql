...
-- Column names are aligned with FinanceShiftsService runtime SQL.
...
CREATE TABLE "FinanceShiftEntry" (
  ...
  "referenceId" UUID,
  "description" TEXT,
  "recordedByAccountId" UUID NOT NULL,
  "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "FinanceShiftHandover" (
  ...
  "fromAccountantId" UUID NOT NULL,
  "toAccountantId" UUID NOT NULL,
...
CREATE INDEX "FinanceShiftEntry_recordedBy_idx" ON "FinanceShiftEntry"("recordedByAccountId", "createdAt");
...
CREATE INDEX "FinanceShiftHandover_receiver_status_idx" ON "FinanceShiftHandover"("toAccountantId", "status");
...
ALTER TABLE "FinanceShiftHandover" ADD CONSTRAINT "FinanceShiftHandover_fromAccountantId_fkey" FOREIGN KEY ("fromAccountantId") REFERENCES "Account"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "FinanceShiftHandover" ADD CONSTRAINT "FinanceShiftHandover_toAccountantId_fkey" FOREIGN KEY ("toAccountantId") REFERENCES "Account"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
