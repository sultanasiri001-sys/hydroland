...
CREATE TABLE "AdministrativeUnit" (
  ...
  "managerAccountId" TEXT NOT NULL, "active" BOOLEAN NOT NULL DEFAULT true,
...
CREATE UNIQUE INDEX "AdministrativeUnit_organizationId_name_key" ON "AdministrativeUnit"("organizationId","name");
CREATE INDEX "AdministrativeUnit_organizationId_active_idx" ON "AdministrativeUnit"("organizationId","active");
...
ALTER TABLE "AdministrativeUnit" ADD CONSTRAINT "AdministrativeUnit_managerAccountId_fkey" FOREIGN KEY ("managerAccountId") REFERENCES "Account"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "AdministrativeRecord" ADD CONSTRAINT "AdministrativeRecord_unitId_fkey" FOREIGN KEY ("unitId") REFERENCES "AdministrativeUnit"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "AdministrativeRouting" ADD CONSTRAINT "AdministrativeRouting_fromUnitId_fkey" FOREIGN KEY ("fromUnitId") REFERENCES "AdministrativeUnit"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "AdministrativeRouting" ADD CONSTRAINT "AdministrativeRouting_toUnitId_fkey" FOREIGN KEY ("toUnitId") REFERENCES "AdministrativeUnit"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "AdministrativeMeeting" ADD CONSTRAINT "AdministrativeMeeting_unitId_fkey" FOREIGN KEY ("unitId") REFERENCES "AdministrativeUnit"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
